...
public class HwArcButtonGroup extends RelativeLayout implements View.OnClickListener {
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.ll_add_buttom_group_add) {
            setBackground();
            openButtonAnimator();
        } else if (view.getId() == R.id.ibtn_add_buttom_group_close) {
            closeButtonAnimator();
        } else {
...
//            backgroundView = llAddButtomGroupAdd;
    ...
    private void initView(View rootView) {
        ibtnAddButtomGroupAdd = (ImageView) rootView.findViewById(R.id.ibtn_add_buttom_group_add);
        llAddButtomGroupAdd = (LinearLayout) rootView.findViewById(R.id.ll_add_buttom_group_add);
        llAddButtomGroupAdd.setOnClickListener(HwArcButtonGroup.this);
        ibtnAddButtomGroupClose = (ImageButton) rootView.findViewById(R.id.ibtn_add_buttom_group_close);
        ibtnAddButtomGroupClose.setOnClickListener(HwArcButtonGroup.this);
        rlAddButtomGroup = (RelativeLayout) rootView.findViewById(R.id.rl_add_buttom_group);
        vAddButtonGroup = (View) rootView.findViewById(R.id.v_add_button_group);
        vAddButtonGroupB = (View) rootView.findViewById(R.id.v_add_button_group_b);
    ...
    private void addImageButton(int position, HwArcDataTypeBean mpAddDataTypeBean) {
        if (rlAddButtomGroup != null) {
            ...
            ImageView imageView = (ImageView) v.findViewById(R.id.iv_add_button_item);
            TextView textView = (TextView) v.findViewById(R.id.tv_add_button_item);
    ...
    public void openButtonAnimator() {
        ...
        for (int i = views.size(); i > 0; i--) {
            ...
            TextView textView = (TextView) views.get(i - 1).findViewById(R.id.tv_add_button_item);
